...
constexpr std::string_view ToString(NavigationStatus s) noexcept {
  switch (s) {
    case NavigationStatus::Unknown:        return "Unknown";
    case NavigationStatus::NotInitialized: return "NotInitialized";
    case NavigationStatus::Initializing:   return "Initializing";
    case NavigationStatus::Nominal:        return "Nominal";
    case NavigationStatus::Degraded:       return "Degraded";
    case NavigationStatus::DeadReckoning:  return "DeadReckoning";
    case NavigationStatus::Fault:          return "Fault";
  }
  return "Unknown";
}
...
constexpr std::string_view ToString(EstimatorMode m) noexcept {
  switch (m) {
    case EstimatorMode::Unknown:             return "Unknown";
    case EstimatorMode::InertialOnly:        return "InertialOnly";
    case EstimatorMode::VisualInertial:      return "VisualInertial";
    case EstimatorMode::GnssInertial:        return "GnssInertial";
    case EstimatorMode::VisualInertialGnss:  return "VisualInertialGnss";
    case EstimatorMode::MultiSensorFusion:   return "MultiSensorFusion";
  }
  return "Unknown";
}
...
constexpr std::string_view ToString(SensorHealth h) noexcept {
  switch (h) {
    ...
    case SensorHealth::Rejected: return "Rejected";
    case SensorHealth::Missing:  return "Missing";
...
constexpr std::string_view ToString(MeasurementValidity v) noexcept {
  switch (v) {
    ...
    case MeasurementValidity::Saturated:  return "Saturated";
    case MeasurementValidity::Dropped:    return "Dropped";
    case MeasurementValidity::OutOfOrder: return "OutOfOrder";
    case MeasurementValidity::Unknown:    return "Unknown";
  }
  return "Unknown";
}
...
constexpr std::string_view ToString(GnssFixType f) noexcept {
  switch (f) {
    ...
    case GnssFixType::Single:                 return "Single";
    case GnssFixType::Differential:           return "Differential";
    case GnssFixType::RtkFloat:               return "RtkFloat";
    case GnssFixType::RtkFixed:               return "RtkFixed";
    case GnssFixType::PrecisePointPositioning: return "PrecisePointPositioning";
  }
  return "NoFix";
}
...
constexpr std::string_view ToString(GnssConstellation c) noexcept {
  switch (c) {
    ...
    case GnssConstellation::Unknown: return "Unknown";
  }
  return "Unknown";
}
...
constexpr std::string_view ToString(estimation::EstimatorBackend b) noexcept {
  switch (b) {
    case estimation::EstimatorBackend::Unknown:           return "Unknown";
    case estimation::EstimatorBackend::Ekf:               return "EKF";
    case estimation::EstimatorBackend::CeresSlidingWindow: return "CeresSlidingWindow";
    case estimation::EstimatorBackend::GtsamFactorGraph:  return "GtsamFactorGraph";
    case estimation::EstimatorBackend::Custom:            return "Custom";
  }
  return "Unknown";
}

inline std::ostream& operator<<(std::ostream& os, estimation::EstimatorBackend b) {
  return os << ToString(b);
}

// ── EstimatorUpdateResult ─────────────────────────────────────────────────────

constexpr std::string_view ToString(estimation::EstimatorUpdateResult r) noexcept {
  switch (r) {
    case estimation::EstimatorUpdateResult::Accepted:       return "Accepted";
    case estimation::EstimatorUpdateResult::Buffered:       return "Buffered";
    case estimation::EstimatorUpdateResult::Rejected:       return "Rejected";
    case estimation::EstimatorUpdateResult::OutOfOrder:     return "OutOfOrder";
    case estimation::EstimatorUpdateResult::NotInitialized: return "NotInitialized";
    case estimation::EstimatorUpdateResult::BackendError:   return "BackendError";
  }
  return "Unknown";
}
