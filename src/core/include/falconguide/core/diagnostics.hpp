...
inline std::ostream &operator<<(std::ostream &os, NavigationStatus s) { return os << ToString(s); }
...
inline std::ostream &operator<<(std::ostream &os, EstimatorMode m) { return os << ToString(m); }
...
inline std::ostream &operator<<(std::ostream &os, SensorHealth h) { return os << ToString(h); }
...
inline std::ostream &operator<<(std::ostream &os, MeasurementValidity v) { return os << ToString(v); }
...
inline std::ostream &operator<<(std::ostream &os, GnssFixType f) { return os << ToString(f); }
...
inline std::ostream &operator<<(std::ostream &os, GnssConstellation c) { return os << ToString(c); }
...
inline std::ostream &operator<<(std::ostream &os, estimation::EstimatorBackend b) { return os << ToString(b); }
...
inline std::ostream &operator<<(std::ostream &os, estimation::EstimatorUpdateResult r) { return os << ToString(r); }
...
inline std::ostream &operator<<(std::ostream &os, AidingSource s) { return os << ToString(s); }
