...
struct ExternalPoseMeasurement {
    ...
    ExternalMeasurementSource source{ExternalMeasurementSource::Unknown};         ///< Producer of the pose estimate.
    Vec3<EcefFrame> position_ecef_m;                                              ///< ECEF position in meters.
    Eigen::Quaterniond orientation_body_to_ecef{Eigen::Quaterniond::Identity()};  ///< Body-to-ECEF orientation.
    Eigen::Matrix<double, 6, 6> covariance{Eigen::Matrix<double, 6, 6>::Zero()};  ///< Pose covariance.
...
struct ExternalVelocityMeasurement {
    Timestamp timestamp;                                                          ///< Sample timestamp.
    ExternalMeasurementSource source{ExternalMeasurementSource::Unknown};         ///< Producer of the velocity
                                                                                  ///< estimate.
    ...
    Eigen::Matrix<double, 6, 6> covariance{Eigen::Matrix<double, 6, 6>::Zero()};  ///< Velocity covariance.
    MeasurementValidity validity{MeasurementValidity::Valid};                     ///< Source validity state.
};
...
struct ExternalOdometryMeasurement {
    Timestamp timestamp;                                                   ///< Sample timestamp.
    ExternalMeasurementSource source{ExternalMeasurementSource::Unknown};  ///< Producer of the odometry
                                                                           ///< estimate.
    Vec3<EcefFrame> position_ecef_m;                                       ///< ECEF position in meters.
    Vec3<EcefFrame> velocity_ecef_mps;                                     ///< ECEF velocity in meters per second.
    Eigen::Quaterniond orientation_body_to_ecef{Eigen::Quaterniond::Identity()};  ///< Body-to-ECEF orientation.
    Eigen::Matrix<double, 9, 9> covariance{Eigen::Matrix<double, 9, 9>::Zero()};  ///< Pose and velocity covariance.
    MeasurementValidity validity{MeasurementValidity::Valid};                     ///< Source validity state.
};
