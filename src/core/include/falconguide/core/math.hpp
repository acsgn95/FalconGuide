...
[[nodiscard]] inline double DegToRad(double degrees) { return degrees * kPi / 180.0; }

/// @brief Converts radians to degrees.
[[nodiscard]] inline double RadToDeg(double radians) { return radians * 180.0 / kPi; }

/// @brief Tests whether two scalar values are within an absolute tolerance.
[[nodiscard]] inline bool Near(double lhs, double rhs, double tolerance) { return std::abs(lhs - rhs) <= tolerance; }
