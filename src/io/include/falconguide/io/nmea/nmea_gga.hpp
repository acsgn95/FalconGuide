...
[[nodiscard]] inline std::optional<double> ParseNmeaLatitudeLongitude(std::string_view value,
                                                                      std::string_view hemisphere, bool is_latitude) {
...
[[nodiscard]] inline std::string FormatNmeaLatitudeLongitude(double radians, bool is_latitude) {
    ...
    stream << std::setw(degree_width) << std::setfill('0') << degrees << std::fixed << std::setprecision(7)
           << std::setw(10) << std::setfill('0') << minutes;
    return stream.str();
}
...
[[nodiscard]] inline std::optional<core::GnssSolution> ParseGga(const NmeaSentence &sentence) {
    ...
    const std::optional<double> latitude = ParseNmeaLatitudeLongitude(sentence.fields[1], sentence.fields[2], true);
    const std::optional<double> longitude = ParseNmeaLatitudeLongitude(sentence.fields[3], sentence.fields[4], false);
    ...
    solution.validity = solution.fix_type == core::GnssFixType::NoFix ? core::MeasurementValidity::Unknown
