 ...
 * @brief EKF star-tracker attitude measurement model.
 */
...
/// @brief Options for EKF star-tracker fusion.
struct StarTrackerOptions {
    ...
    // Use pitch and roll components from measurement (requires pitch_rad /
    // roll_rad present).
...
//
/// @brief EKF measurement model for celestial attitude updates.
