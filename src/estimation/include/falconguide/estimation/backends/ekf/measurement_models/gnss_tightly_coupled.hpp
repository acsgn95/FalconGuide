...
private:
  ...
  bool ScalarUpdate(Eigen::VectorXd &error_state, Eigen::MatrixXd &covariance,
                    const Eigen::VectorXd &H_row, double innovation,
                    double sigma) const;
  ...
  static double SagnacCorrectionM(const Eigen::Vector3d &pos_sv_ecef_m,
