...
/**
 * @file ukf_magnetometer.hpp
 * @brief UKF magnetometer attitude-heading measurement model.
 */
...
/// @brief Options for UKF magnetometer fusion.
...
/// @brief UKF measurement model for 3-axis magnetic-field updates.
