...
struct GtsamOptions {
    ...
    SmootherMode smoother_mode{SmootherMode::ISAM2};  ///< Smoother implementation mode.
    ...
    double node_min_distance_m{0.5};    ///< Create a new node after this translation.
    ...
    // enabled.
    double vision_reprojection_sigma_px{1.5};  ///< Vision reprojection sigma in pixels.
