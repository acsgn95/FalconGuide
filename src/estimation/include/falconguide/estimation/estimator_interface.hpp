...
using SensorMeasurement =
    std::variant<core::ImuMeasurement, core::MagnetometerMeasurement,
                 core::BarometerMeasurement, core::RadarAltimeterMeasurement,
                 core::WheelEncoderMeasurement, core::WheelOdometryMeasurement,
                 core::AirspeedMeasurement, core::RangeFinderMeasurement,
                 core::OpticalFlowMeasurement, core::DvlMeasurement,
                 core::EchoSounderMeasurement, core::ExternalPoseMeasurement,
                 core::ExternalVelocityMeasurement,
                 core::ExternalOdometryMeasurement, core::GnssObservationEpoch,
                 core::GnssSolution, core::CameraFrameMeasurement,
                 core::GeoReferenceImageMeasurement, core::AidingSolution,
                 core::StarTrackerMeasurement, core::GnssTightlyCoupledEpoch>;
...
struct MeasurementUpdateReport {
  EstimatorUpdateResult result{
      EstimatorUpdateResult::Rejected}; ///< High-level update outcome.
...
struct EstimatorOptions {
  EstimatorBackend backend{
      EstimatorBackend::Unknown}; ///< Backend selected for this estimator.
  std::size_t max_buffered_measurements{
      0}; ///< Maximum queued or buffered measurements.
  bool enable_sensor_health_reporting{
      true}; ///< Enables population of per-sensor status fields.
  bool enable_covariance_output{
      true}; ///< Enables covariance export in NavigationState.
};
...
public:
  ...
  virtual MeasurementUpdateReport
  AddMeasurement(const SensorMeasurement &measurement) = 0;
  /// @brief Processes all buffered data up to a target timestamp.
  virtual EstimatorUpdateResult
  ProcessUntil(const core::Timestamp &timestamp) = 0;
  ...
  [[nodiscard]] virtual std::optional<core::NavigationState>
  LatestState() const = 0;
};
