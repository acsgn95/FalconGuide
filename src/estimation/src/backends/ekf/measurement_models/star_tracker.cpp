...
EstimatorUpdateResult StarTracker::Apply(NominalState& nominal, Eigen::VectorXd& error_state,
    ...
    (void)pitch;
    (void)roll;  // used implicitly through star tracker orientation math
