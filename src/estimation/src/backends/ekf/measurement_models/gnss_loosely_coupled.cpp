...
GnssLooselyCoupled::GnssLooselyCoupled(GnssLooselyCoupledOptions options)
...
EstimatorUpdateResult GnssLooselyCoupled::Apply(
...
EstimatorUpdateResult GnssLooselyCoupled::ApplySolution(
    NominalState& nominal,
    Eigen::VectorXd& error_state,
    Eigen::MatrixXd& covariance,
    const StateLayout& layout,
