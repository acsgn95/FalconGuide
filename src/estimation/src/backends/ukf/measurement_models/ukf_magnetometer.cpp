...
Eigen::VectorXd UkfMagnetometer::Predict(const NominalState& sigma_state, const UkfUpdateContext& /*ctx*/) const {
...
std::optional<Eigen::VectorXd> UkfMagnetometer::Observe(const SensorMeasurement& measurement,
...
Eigen::MatrixXd UkfMagnetometer::NoiseCovariance(const SensorMeasurement& /*measurement*/,
                                                 const UkfUpdateContext& /*ctx*/) const {
