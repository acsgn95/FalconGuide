...
int main() {
    ...
    const Transform<EcefFrame, EnuFrame> ecef_to_enu(Eigen::Quaterniond::Identity(), Vec3<EnuFrame>(10.0, 0.0, 0.0));
    ...
    const auto parsed_sentence =
        falconguide::io::nmea::ParseSentence("$GPGGA,123519,4807.038,N,01131.000,E,1,08,0.9,545.4,M,46.9,M,,*47");
